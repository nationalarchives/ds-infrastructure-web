...
web_reverse_proxy_deployment_s3_bucket = "ds-live-deployment-source"
web_reverse_proxy_instance_type = "t4g.large"
web_reverse_proxy_key_name      = "web-frontend-live-eu-west-2"
