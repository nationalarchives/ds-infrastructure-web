...
web_reverse_proxy_deployment_s3_bucket = "ds-staging-deployment-source"
web_reverse_proxy_instance_type = "t4g.medium"
web_reverse_proxy_key_name      = "web-frontend-staging-eu-west-2"
