...
| `web-wagtail`               | Wagtail CMS                                  | Mounted **EFS** at `/media`. Handles content management.                                     |
| `web-catalogue`             | Catalogue service                            | Handles catalogue API. Reverse proxied via **beta-rp** instance.                             |
| `web-search`                | Search service                               | Handles search functionality. Reverse proxied via **beta-rp** instance. (Later changes to website-reverse-proxy)                     |
